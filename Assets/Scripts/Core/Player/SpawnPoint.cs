...
public class SpawnPoint : MonoBehaviour
{
    ...
    private static List<SpawnPoint> shipPoints = new List<SpawnPoint>(); // Gemi listesi
    ...
    private void Awake()
    {
        ...
        else { if (!shipPoints.Contains(this)) shipPoints.Add(this); }
    }
